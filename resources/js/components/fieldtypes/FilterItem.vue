<template>
    ...
    >
        ...
        >
            <DragHandle v-if="!readOnly" class="filter-builder-sortable-handle size-4 cursor-grab text-gray-400" />
            <button
                type="button"
            ...
            <button
                ...
                :aria-label="__('statamic-filter-builder::fieldtypes.filter_builder.delete_filter')"
            >
